...
fn compute_graph_from_csv<P: AsRef<Path>>(path: P) -> io::Result<Graph> {
    ...
    for line in reader.lines() {
        ...
        if parts.len() >= 3 {  // Ignore first column, use second and third
...
impl Graph {
    ...
    fn find_all_paths(&self, start: &str, target_nodes: HashSet<String>) -> HashMap<String, Vec<Vec<String>>> {
